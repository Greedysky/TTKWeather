...
QString WeatherCryptographicHash::encrypt(const QString &data, const QString &key, Priority p)
{
    QString d = data;
    for(int i=0; i<p; ++i)
    {
...
QString WeatherCryptographicHash::decrypt(const QString &data, const QString &key, Priority p)
{
    QString d = data;
    for(int i=0; i<p; ++i)
    {
...
QString WeatherCryptographicHash::encryptData(const QString &data, const QString &key, Priority p)
{
    return WeatherCryptographicHash().encrypt(data, key, p);
}

QString WeatherCryptographicHash::decryptData(const QString &data, const QString &key, Priority p)
{
    return WeatherCryptographicHash().decrypt(data, key, p);
}

std::string WeatherCryptographicHash::xxteaEncrypt(std::string data, std::string key)
{
...
std::string WeatherCryptographicHash::xxteaDecrypt(std::string data,  std::string key)
{
...
bool WeatherCryptographicHash::isBase64(unsigned char c)
{
    return (isalnum(c) || (c == '+') || (c == '/'));
}

std::string WeatherCryptographicHash::base64Encode(unsigned char const* bytes_to_encode, unsigned int in_len)
{
    std::string ret;
    int i = 0, j = 0;
...
std::string WeatherCryptographicHash::base64Decode(std::string const& encoded_string)
{
...
unsigned char *WeatherCryptographicHash::fixKeyLength(unsigned char *key, xxtea_uint key_len)
{
...
xxtea_uint *WeatherCryptographicHash::xxteaToUintArray(unsigned char *data, xxtea_uint len, int include_length, xxtea_uint *ret_len)
{
...
unsigned char *WeatherCryptographicHash::xxteaToByteArray(xxtea_uint *data, xxtea_uint len, int include_length, xxtea_uint *ret_len)
{
    xxtea_uint i, n, m;
...
unsigned char *WeatherCryptographicHash::doXxteaEncrypt(unsigned char *data, xxtea_uint len, unsigned char *key, xxtea_uint *ret_len)
{
    unsigned char *result;
...
unsigned char *WeatherCryptographicHash::doXxteaDecrypt(unsigned char *data, xxtea_uint len, unsigned char *key, xxtea_uint *ret_len)
{
    unsigned char *result;
    xxtea_uint *v, *k, v_len, k_len;
...
unsigned char *WeatherCryptographicHash::xxteaEncrypt(unsigned char *data, xxtea_uint data_len, unsigned char *key, xxtea_uint key_len, xxtea_uint *ret_length)
{
    unsigned char *result;
...
unsigned char *WeatherCryptographicHash::xxteaDecrypt(unsigned char *data, xxtea_uint data_len, unsigned char *key, xxtea_uint key_len, xxtea_uint *ret_length)
{
    unsigned char *result;
