...
"%base%\pvk2pfx.exe" -pvk %temp%\CbipSetupKey.pvk -spc %temp%\CbipSetupKey.spc -f -pfx %userprofile%\Desktop\TTKWeather.pfx
"%base%\signtool.exe" sign /f %userprofile%\Desktop\TTKWeather.pfx  /t "http://timestamp.verisign.com/scripts/timstamp.dll" /d "TTKWeather" %1
del %temp%\CbipSetupKey.* >nul 2>nul
del %userprofile%\Desktop\TTKWeather.pfx >nul 2>nul
