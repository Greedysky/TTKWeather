#ifndef WEATHERCONFIGMODULE_H
#define WEATHERCONFIGMODULE_H
...
#include "weatherconfigdefine.h"

/*! @brief The class of the initialize module.
 * @author Greedysky <greedysky@163.com>
 */
class TTK_MODULE_EXPORT WeatherConfigModule : public QObject
{
    Q_OBJECT
public:
    /*!
     * Object constructor.
     */
    explicit WeatherConfigModule(QObject *parent = nullptr);
